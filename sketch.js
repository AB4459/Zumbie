...
ground.scale=1.4;
   ...
   girl=createSprite(width-300,height-80,windowWidth,10);
 ...
 // girl.velocityX=2;
  ...
  zombie=createSprite(width-550,height-90,windowWidth,10);
 ...
 // zombie.velocityX=Math.round(random(1,2));
  ...
  invisible_ground=createSprite(width-300,height-45,windowWidth,10);
  invisible_ground.visible=false;
  
   gameOver = createSprite(width-325,height-400);
  gameOver.addImage(gameOverImage);
  
  restart = createSprite(width-325,height-320);
...
function spawnObstacles() {
   if (frameCount % 60 === 0){
   var obstacle = createSprite(windowWidth,height-65,10,40);
